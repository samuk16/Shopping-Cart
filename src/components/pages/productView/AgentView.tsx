import { AgentsType, contextTypes } from "@/lib/types";
...
function AgentView({ item }: StickerProps) {
          ...
          <div className="flex justify-center">
            <div className="flex flex-col gap-2 w-[500px]">
              <div className="flex justify-between p-2 border border-slate-400 dark:border-slate-800 rounded-sm text-black dark:text-slate-400">
                Type
                <p className="text-black dark:text-white">Agent</p>
              </div>
              <div className="flex justify-between p-2 border border-slate-400 dark:border-slate-800 rounded-sm text-black dark:text-slate-400">
                Team
                <p className="text-black dark:text-white">{item.team.name}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {item.collections && item.collections[0] ? (
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col items-center">
              <img
                src={item.collections[0].image}
                alt={item.collections[0].name}
              />
